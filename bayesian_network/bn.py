...
from extended_classes import DiscreteBayesianNetwork
...
def build_bn():
    ...
    values_dictionary = {
        ...
        RUNOFF_COEFFICIENT: [
            [0.75, 0.65, 0.4, 0.9, 1 / 3, 0.6, 0.65, 0.35, 0.7, 1 / 3, 0.5, 0.55, 0.3, 0.7, 1 / 3, 0.8, 0.85, 0.7, 0.9,
             1 / 3, 0.65, 0.7, 0.55, 0.75, 1 / 3, 0.45, 0.5, 0.35, 0.55, 1 / 3],
            [0.15, 0.25, 0.4, 0.09, 1 / 3, 0.3, 0.25, 0.35, 0.2, 1 / 3, 0.4, 0.35, 0.4, 0.2, 1 / 3, 0.15, 0.1, 0.2,
             0.09, 1 / 3, 0.25, 0.25, 0.35, 0.125, 1 / 3, 0.25, 0.3, 0.3, 0.25, 1 / 3],
            [0.1, 0.1, 0.2, 0.01, 1 / 3, 0.1, 0.1, 0.3, 0.1, 1 / 3, 0.1, 0.1, 0.3, 0.1, 1 / 3, 0.05, 0.05, 0.1, 0.01,
             1 / 3, 0.1, 0.05, 0.1, 0.125, 1 / 3, 0.3, 0.2, 0.35, 0.2, 1 / 3]
        ],
        ...
        VULNERABILITY: [
            [0.1, 0.15, 0.3, 0.1, 0.3, 0.5, 0.2, 0.4, 0.75, 0.15, 0.25, 0.4, 0.2, 0.35, 0.5, 0.3, 0.4, 0.6, 0.01, 0.05,
             0.2,
             0.05, 0.2, 0.3, 0.1, 0.25, 0.4],
            [0.2, 0.25, 0.3, 0.2, 0.5, 0.4, 0.3, 0.45, 0.2, 0.25, 0.35, 0.45, 0.35, 0.45, 0.4, 0.4, 0.5, 0.25, 0.09,
             0.15,
             0.3, 0.15, 0.35, 0.4, 0.2, 0.35, 0.4],
            [0.7, 0.6, 0.4, 0.7, 0.2, 0.1, 0.5, 0.15, 0.05, 0.6, 0.4, 0.15, 0.45, 0.2, 0.1, 0.3, 0.1, 0.15, 0.9, 0.8,
             0.5,
        ...
        EXPOSURE: [
            [0.5, 0.6, 0.9, 0.4, 0.45, 0.5, 0.35, 0.4, 0.45, 0.5, 0.45, 0.6, 0.3, 0.35, 0.45, 0.4, 0.45, 0.5, 0.35,
             0.375,
             0.425, 0.275, 0.35, 0.4, 0.01, 0.2, 0.3],
            [0.4, 0.3, 0.09, 0.4, 0.4, 0.4, 0.3, 0.3, 0.4, 0.4, 0.4, 0.3, 0.5, 0.4, 0.4, 0.45, 0.4, 0.4, 0.35, 0.325,
             0.3,
             0.35, 0.325, 0.3, 0.09, 0.2, 0.2],
            [0.1, 0.1, 0.01, 0.2, 0.15, 0.1, 0.35, 0.3, 0.15, 0.1, 0.15, 0.1, 0.2, 0.25, 0.15, 0.15, 0.15, 0.1, 0.3,
             0.3,
             0.275, 0.375, 0.325, 0.3, 0.9, 0.6, 0.5]
        ],

        FLOOD_RISK: [
            [0.9, 0.8, 0.7, 0.85, 0.75, 0.65, 0.6, 0.55, 0.5, 0.8, 0.7, 0.6, 0.65, 0.55, 0.45, 0.5, 0.4, 0.3, 0.4, 0.3,
             0.2,
             0.15, 0.1, 0.05, 0.1, 0.05, 0.01],
            [0.1, 0.2, 0.3, 0.15, 0.25, 0.35, 0.4, 0.45, 0.5, 0.2, 0.3, 0.4, 0.35, 0.45, 0.55, 0.5, 0.6, 0.7, 0.6, 0.7,
             0.8,
...
# Basisverzeichnis relativ zu dieser Python-Datei
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Dynamische Pfade bauen
