...
values_dictionary = {
    ...
    HAZARD: [
        [0.4, 0.99, 0.5,  0.3, 0.4, 0.3,  0.05, 0.1, 0.05],
        [0.4, 0.01, 0.2,  0.4, 0.4, 0.5,  0.15, 0.2, 0.15],
        [0.2, 0.0, 0.3,  0.3, 0.2, 0.2,  0.8, 0.7, 0.8]
    ],
    ...
    EXPOSURE: [
        [0.5, 0.7, 0.99,   0.4, 0.45, 0.7,  0.35, 0.4, 0.45,  0.5, 0.45, 0.7,  0.3, 0.35, 0.5,    0.2, 0.35, 0.4,  0.35, 0.375, 0.5,      0.15, 0.35, 0.45,    0.0, 0.2, 0.3],
        [0.4, 0.2, 0.01,  0.4, 0.4, 0.2,   0.3, 0.3, 0.4,     0.4, 0.4, 0.2,   0.5, 0.4, 0.35,    0.35, 0.25, 0.3,  0.35, 0.325, 0.3,    0.25, 0.275, 0.25,   0.01, 0.2, 0.2],
        [0.1, 0.1, 0.0,  0.2, 0.15, 0.1,   0.35, 0.3, 0.15,  0.1, 0.15, 0.1,   0.2, 0.25, 0.15,  0.45, 0.4, 0.3,   0.3,   0.3, 0.2,       0.6, 0.375, 0.3,      0.99, 0.6, 0.5]

    ],

    FLOOD_RISK: [
        [0.99, 0.8, 0.7,  0.85, 0.75, 0.65,  0.6, 0.55, 0.5,  0.8, 0.7, 0.6,  0.65, 0.55, 0.45,  0.5, 0.4, 0.3,  0.4, 0.3, 0.2,  0.15, 0.1, 0.05,  0.1, 0.05, 0.01],
        [0.01, 0.2, 0.3,  0.15, 0.25, 0.35,  0.4, 0.45, 0.5,  0.2, 0.3, 0.4,  0.35, 0.45, 0.55,  0.5, 0.6, 0.7,  0.6, 0.7, 0.8,  0.85, 0.9, 0.95,  0.9, 0.95, 0.99]
    ],
}
...
target_variable = 'VULNERABILITY'

sensitivity_results = perform_sensitivity_analysis(target_variable, exact_infer, evidence, analyze_vulnerability, model)
